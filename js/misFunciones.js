function traerInformacionCategorias(){
    $.ajax({
        url:"http://144.22.56.129:80/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionBotes(){
    $.ajax({
        url:"http://144.22.56.129:80/api/Boat/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function traerInformacionClientes(){
    $.ajax({
        url:"http://144.22.56.129:80/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function traerInformacionMensajes(){
    $.ajax({
        url:"http://144.22.56.129:80/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function traerInformacionReservaciones(){
    $.ajax({
        url:"http://144.22.56.129:80/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
    ...
    if($("#nameCategoria").val() !== "" &
       $("#descriptionCategoria").val() !== "" ){
            ...
            $.ajax({
                ...
                url:"http://144.22.56.129:80/api/Category/save",
    ...
    if($("#name").val() !== "" &
       ...
       $("#description").val() !== "" ){
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: JSON.stringify(var2),
                url:"http://144.22.56.129:80/api/Boat/save",
                success:function(response) {
                    console.log(response);
                    console.log("Se guardo correctamente");
                    alert("Se guardo correctamente");
    ...
    if($("#email").val() !== "" &
       ...
       $("#age").val() !== "" ){
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: JSON.stringify(var2),
                url:"http://144.22.56.129:80/api/Client/save",
                success:function(response) {
                    console.log(response);
                    console.log("Se guardo correctamente");
                    alert("Se guardo correctamente");
...
function guardarInformacionMensajes(){
    ...
    if($("#messagetext").val() !== ""){
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: JSON.stringify(var2),
                url:"http://144.22.56.129:80/api/Message/save",
                success:function(response) {
                    console.log(response);
                    console.log("Se guardo correctamente");
                    alert("Se guardo correctamente");
    ...
    if($("#startDate").val() !== "" &
       ...
       $("#status").val()  !== ""){
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: JSON.stringify(var2),
                url:"http://144.22.56.129:80/api/Reservation/save",
                success:function(response) {
                    console.log(response);
                    console.log("Se guardo correctamente");
                    alert("Se guardo correctamente");
...
function actualizarInformacionCategorias(idElemento){
    ...
    if($("#nameCategoria").val() !== "" &
       $("#descriptionCategoria").val() !== "" ){
            ...
            $.ajax({
                url:"http://144.22.56.129:80/api/Category/update",
                type:"PUT",
                data:dataToSend,
...
function actualizarInformacionBotes(idElemento){
    ...
    if($("#name").val() !== "" &
       ...
       $("#description").val() !== "" ){
            ...
            let dataToSend=JSON.stringify(myData);
            $.ajax({
                url:"http://144.22.56.129:80/api/Boat/update",
                type:"PUT",
                data:dataToSend,
                contentType:"application/JSON",
                datatype:"JSON",
...
function actualizarInformacionClientes(idElemento){
    ...
    if($("#email").val() !== "" &
       ...
       $("#age").val() !== "" ){    
            ...
            let dataToSend=JSON.stringify(myData);
            $.ajax({
                url:"http://144.22.56.129:80/api/Client/update",
                type:"PUT",
                data:dataToSend,
                contentType:"application/JSON",
                datatype:"JSON",
...
function actualizarInformacionMensajes(idElemento){
    ...
    if($("#messagetext").val() !== ""){
            ...
            let dataToSend=JSON.stringify(myData);
            $.ajax({
                url:"http://144.22.56.129:80/api/Message/update",
                type:"PUT",
                data:dataToSend,
                contentType:"application/JSON",
                datatype:"JSON",
...
function actualizarInformacionReservaciones(idElemento){
    ...
    if($("#startDate").val() !== "" &
       ...
       $("#status").val()  !== ""){
            ...
            let dataToSend=JSON.stringify(myData);
            $.ajax({
                url:"http://144.22.56.129:80/api/Reservation/update",
                type:"PUT",
                data:dataToSend,
                contentType:"application/JSON",
                datatype:"JSON",
...
function borrarElementoCategoria(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://144.22.56.129:80/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoBote(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://144.22.56.129:80/api/Boat/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoCliente(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://144.22.56.129:80/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoMensaje(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://144.22.56.129:80/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoReservacion(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://144.22.56.129:80/api/Reservation/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
